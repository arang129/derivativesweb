...
def setup_derivativesweb():
    ...
    return {
        'command': [
            "streamlit", "run", "/home/jupyter-data/webapp/derivativesweb.py",
        ...
        'launcher_entry': {
            'title': '金融工具',
            'icon_path': os.path.join(os.path.dirname(os.path.abspath(__file__)), 'icons', 'derivativesweb.svg'),
        }
    }
